...
| Proposed citation | Status | Claim it supports | Where it would land | Priority | Notes |
|---|---|---|---|---|---|
| **Schafer, J. L. & Graham, J. W. (2002).** "Missing data: our view of the state of the art." *Psychological Methods* 7(2), 147–177. | **acquired** (`schaferMissingDataOur2002a`, lit-synced 2026-06-06; not yet read in-session) | Maturity narrative: MI as gold-standard, what is settled (mechanisms, point estimation, Wald-type inference) — stated by an applied-facing authority | M1 ¶1 (sec-intro opening) | High | Migrated Zotero → Drive 2026-06-06 (`schafer_missing_data_our_2002.pdf`). Pending Mathpix convert → lit-sync → verify. Training-weight knowledge; verify exact claims on read. |
